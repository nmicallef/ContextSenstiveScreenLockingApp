...
public class ExtAudioRecorder
{
	...
	*/
	...
	private ArrayList        allAmplitude= new ArrayList();
	...
	*/
	...
	public ArrayList getAllAmplitude()
	{
		return allAmplitude;
	}
			...
			try
			{
				...
				if (bSamples == 16)
				{
					...
					{ // 16bit sample size
						...
						//allAmplitude.add(curSample);
						//System.out.println("Noise dB level: "+dB);
					}
					allAmplitude.add(cAmplitude);
				}
				else
				{ // 8bit sample size
